...
<div class="main-header">
    ...
    <p>Tác giả: Đặng Thị Hồng Liễu - Trường Tiểu học Ngọc Đường - ĐT: 0848270383</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đặng Thị Hồng Liễu - Trường Tiểu học Ngọc Đường - ĐT: 0848270383</div>", unsafe_allow_html=True)
